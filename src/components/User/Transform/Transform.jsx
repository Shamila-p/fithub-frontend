...
function Transform() {
  return (
    <div className='transform-container'>
        ...
        <button style={{background:"#df0a0a",color:"black",textAlign:"center",padding:"16px 35px",border:"1px",borderRadius:"27px",fontSize:"16px",marginLeft:"45%",marginBottom:"30px"}}><b>Get Started</b></button>
    </div>
  )
}
